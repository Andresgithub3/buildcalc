...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "mulch" });
  ...
  return {
    ...
    openGraph: {
      ...
      url: getLocalizedUrl("/calculators/mulch-and-topsoil", locale),
      siteName: "SlabCalc",
      type: "website",
    },
    twitter: {
    ...
    alternates: getAlternates("/calculators/mulch-and-topsoil", locale),
  };
}

export default async function MulchTopsoilPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
