...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "footing" });
  ...
  return {
    ...
    openGraph: {
      ...
      url: getLocalizedUrl("/calculators/concrete-footing", locale),
      siteName: "SlabCalc",
      type: "website",
    },
    twitter: {
    ...
    alternates: getAlternates("/calculators/concrete-footing", locale),
  };
}

export default async function ConcreteFootingPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
